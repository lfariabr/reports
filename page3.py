...
def render_page3():
    ...
    st.markdown('# LEADS PAGOS')
    st.markdown('##### Aqui temos a visão geral de todos os leads, de fontes pagas')
    st.markdown('###### As lista de fontes pode ser encontrada nos filtros da página 3 no sidebar')
    ...
    with col2:
        ...
        fig_area = px.area(df_area, x='ano', y='Total de Leads', color='Categoria', title='Categoria dos Leads Pagos x Ano Empilhada')
    ...
    with col1:
        ...
        fig_line = px.line(df_line, x='mes_ano', y='Total de Leads', markers=True, title='Entrada de Leads Pagos Mês/Ano')
